    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"> <a href="{{ route('home') }}">Beranda</a> </li> <li class="breadcrumb-item
                active">Ubah Penerbit</li> </ol> </div> </div>
    </div> <!-- /.container-fluid -->
            ...
            <div class="form-group">
                ...
                <span class="invalid-feedback" role="alert">
                    ...
                    <textarea id="inputAlamat" name="alamat" rows="4" cols="50" class=?form-control
                        @error('alamat') is-invalid @enderror required="required">{{ $penerbit->alamat }}</textarea>
                    @error('alamat')
                    <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
